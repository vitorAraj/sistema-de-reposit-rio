    ...
    <?php while($resultset = $cadastro->fetch_array()) { ?> 
        <li class="list-group-item">
            ...
            <a href="sobreArtigo.php?id=<?php echo $resultset['Id_user']; ?>">
               <h7> <?php echo $resultset['titulo_artigo']; ?> </h7>
            </a> 
             <p class="Autoria"> <?php echo $resultset['Autoria']; ?> </p>
        </li>
    <?php } ?>
</ul>
</div>
...
<footer>
   <strong> <h4 class="sidebar-heading"><img src="img\guia.png" alt="Logo" class="logo-img me-2">Artigos</h4></strong>
